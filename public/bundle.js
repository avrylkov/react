...
var ExGridViewRow = function (_React$Component) {
    _inherits(ExGridViewRow, _React$Component);

    function ExGridViewRow(props) {
        _classCallCheck(this, ExGridViewRow);

        var _this = _possibleConstructorReturn(this, (ExGridViewRow.__proto__ || Object.getPrototypeOf(ExGridViewRow)).call(this, props));

        _this.nameChange = _this.nameChange.bind(_this);
        _this.editChange = _this.editChange.bind(_this);

        var id = _this.props.match.params.id;
        var record = _dataProvider.DataProvider.byId(id);
        _this.state = {
            record: record
        };
        return _this;
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'label',
                            null,
                            _react2.default.createElement('input', { type: 'checkbox', checked: this.state.record.edit, onChange: this.editChange }),
                            '\u0421\u0442\u0430\u0442\u0443\u0441'
                        )
                    )
                ),
    ...
    return ExGridViewRow;
}(_react2.default.Component);

exports.default = ExGridViewRow;
...
var _exVisibility = __webpack_require__(77);

var _exVisibility2 = _interopRequireDefault(_exVisibility);

var _exGridEdit = __webpack_require__(78);

var _exGridEdit2 = _interopRequireDefault(_exGridEdit);

var _exGridView = __webpack_require__(79);

var _exGridView2 = _interopRequireDefault(_exGridView);

var _exGridViewRow = __webpack_require__(36);

var _exGridViewRow2 = _interopRequireDefault(_exGridViewRow);

var _exFilterSelect = __webpack_require__(80);

var _exFilterSelect2 = _interopRequireDefault(_exFilterSelect);

var _exSelectGridRow = __webpack_require__(81);

var _exSelectGridRow2 = _interopRequireDefault(_exSelectGridRow);

var _exSelect = __webpack_require__(82);
...
(0, _reactDom.render)(_react2.default.createElement(
    ...
    _react2.default.createElement(
        ...
        _react2.default.createElement('hr', { className: 'clear' }),
        _react2.default.createElement(
            'main',
            null,
            _react2.default.createElement(
                ...
                null,
                _react2.default.createElement(_reactRouterDom.Route, { path: '/exVisibility', component: _exVisibility2.default }),
                _react2.default.createElement(_reactRouterDom.Route, { path: '/exGridEdit', component: _exGridEdit2.default }),
                _react2.default.createElement(_reactRouterDom.Route, { path: '/exGridView', component: _exGridView2.default }),
...
var ExVisibility = function (_React$Component) {
    _inherits(ExVisibility, _React$Component);

    function ExVisibility() {
        _classCallCheck(this, ExVisibility);

        var _this = _possibleConstructorReturn(this, (ExVisibility.__proto__ || Object.getPrototypeOf(ExVisibility)).call(this));
    ...
    _createClass(ExVisibility, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { type: 'checkbox', onChange: this.toggleVisible, checked: this.state.visible }),
                _react2.default.createElement(
                    'span',
                    null,
                    '\u041D\u0435 \u0434\u043E\u0441\u0442\u0443\u043F\u0435\u043D'
                ),
                _react2.default.createElement('input', { type: 'checkbox', onChange: this.toggleEnable, checked: this.state.enable }),
                _react2.default.createElement('br', null),
                _react2.default.createElement(
                    'span',
                    null,
                ...
                this.state.visible && _react2.default.createElement('input', { type: 'text',
...
var GridRecord = function (_React$Component) {
    _inherits(GridRecord, _React$Component);

    function GridRecord() {
        _classCallCheck(this, GridRecord);

        var _this = _possibleConstructorReturn(this, (GridRecord.__proto__ || Object.getPrototypeOf(GridRecord)).call(this));
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'td',
                    null,
                    _react2.default.createElement('input', { type: 'text', value: record.name, onChange: this.nameChange, disabled: record.edit })
                ),
                _react2.default.createElement(
                    'td',
                    null,
...
var ExGrid = function (_React$Component2) {
    _inherits(ExGrid, _React$Component2);

    function ExGrid() {
        _classCallCheck(this, ExGrid);

        var _this2 = _possibleConstructorReturn(this, (ExGrid.__proto__ || Object.getPrototypeOf(ExGrid)).call(this));

        _this2.state = {
            records: []
        };

        _this2.nameChange = _this2.nameChange.bind(_this2);
        _this2.editChange = _this2.editChange.bind(_this2);
        return _this2;
    }
    ...
    _createClass(ExGrid, [{
        ...
        value: function componentDidMount() {
            this.setState({
                records: _dataProvider.DataProvider.all()
            });
        }
    }, {
        key: 'nameChange',
        value: function nameChange(newValue, index) {
        ...
        key: 'editChange',
        value: function editChange(newValue, index) {
            var records = this.state.records;
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        this.state.records.map(function (record, index) {
                            return _react2.default.createElement(GridRecord, { record: record,
                                key: index,
                                index: index,
                                onNameChange: _this3.nameChange,
                                onEditChange: _this3.editChange
                            });
                        })
                    )
                )
...
var ExGridView = function (_React$Component) {
    _inherits(ExGridView, _React$Component);

    function ExGridView(props) {
        _classCallCheck(this, ExGridView);

        var _this = _possibleConstructorReturn(this, (ExGridView.__proto__ || Object.getPrototypeOf(ExGridView)).call(this, props));
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        null,
                        this.state.records.map(function (record, index) {
                            return _react2.default.createElement(RecordView, { record: record,
                                key: index
                            });
                        })
                    )
...
var SearchList = function (_React$Component2) {
    _inherits(SearchList, _React$Component2);

    function SearchList(props) {
        _classCallCheck(this, SearchList);

        var _this2 = _possibleConstructorReturn(this, (SearchList.__proto__ || Object.getPrototypeOf(SearchList)).call(this, props));
    ...
    _createClass(SearchList, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'select',
                { className: 'box', size: 10, onChange: this.handleSelect },
                filteredRows
            );
        }
    }]);
...
var ExFilterSelect = function (_React$Component3) {
    _inherits(ExFilterSelect, _React$Component3);

    function ExFilterSelect(props) {
        _classCallCheck(this, ExFilterSelect);

        var _this3 = _possibleConstructorReturn(this, (ExFilterSelect.__proto__ || Object.getPrototypeOf(ExFilterSelect)).call(this, props));

        _this3.handleInputChange = _this3.handleInputChange.bind(_this3);
        _this3.handleListSelect = _this3.handleListSelect.bind(_this3);
        _this3.state = { search: '', selectId: '', filteredData: [] };
        return _this3;
    }

    _createClass(ExFilterSelect, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            this.setState({
        ...
        value: function handleListSelect(value, label) {
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement(SearchList, {
    ...
    return ExFilterSelect;
}(_react2.default.Component);

exports.default = ExFilterSelect;
...
var GridRow = function (_React$Component) {
    ...
    _createClass(GridRow, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'tr',
                { onClick: this.clickEvent, className: record.edit ? "selectRow" : "" },
                _react2.default.createElement(
                    'td',
                    null,
                    record.id
...
var ExSelectGridRow = function (_React$Component2) {
    _inherits(ExSelectGridRow, _React$Component2);

    function ExSelectGridRow() {
        _classCallCheck(this, ExSelectGridRow);

        var _this2 = _possibleConstructorReturn(this, (ExSelectGridRow.__proto__ || Object.getPrototypeOf(ExSelectGridRow)).call(this));
        ...
        _this2.selectRow = _this2.selectRow.bind(_this2);
        return _this2;
    }

    _createClass(ExSelectGridRow, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            this.setState({
                records: _dataProvider.DataProvider.all()
        ...
        key: 'selectRow',
        value: function selectRow(e, record) {
            var records = this.state.records;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        this.state.records.map(function (record, index) {
                            return _react2.default.createElement(GridRow, { record: record,
                                key: index,
                                index: index,
                                onSelectRow: _this3.selectRow
                            });
                        })
                    )
                )
    ...
    return ExSelectGridRow;
}(_react2.default.Component);

exports.default = ExSelectGridRow;
...
var Select = function (_React$Component) {
    ...
    function Select(props) {
        ...
        _this.handleListSelect = _this.handleListSelect.bind(_this);
        return _this;
    }
...
var ExSelect = function (_React$Component2) {
    _inherits(ExSelect, _React$Component2);

    function ExSelect(props) {
        _classCallCheck(this, ExSelect);
    ...
    _createClass(ExSelect, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            this.setState({
                data: _dataProvider.DataProvider.all()
            });
        }
    }, {
        key: 'handleListSelect',
        value: function handleListSelect(value) {
            console.log(value);
